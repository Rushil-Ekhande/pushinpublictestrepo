      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        <section className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.12)]">
          <div className="grid gap-8 border-b border-slate-200 bg-[linear-gradient(135deg,#0f172a,#334155)] px-6 py-8 text-white sm:px-10 lg:grid-cols-[1.15fr_0.85fr] lg:px-12 lg:py-10">
            ...
            <div className="grid gap-4 rounded-[1.25rem] border border-white/10 bg-white/5 p-5 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
              <div>
            ...
            <div className="space-y-3">
              {filteredTodos.length === 0 ? (
                ...
                filteredTodos.map((todo) => (
                  <div
                    key={todo.id}
                    className="flex items-center gap-4 rounded-3xl border border-slate-200 bg-white px-4 py-4 shadow-sm transition hover:border-slate-300 hover:shadow-md"
                  >
                    <button
                      type="button"
